...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ config('app.name', 'Fantasy Football') }} - Login</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <a href="{{url('/')}}"><img src="{{asset('frontend/images/short-logo.svg')}}" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 text">
                        <div class="form-box">
                            ...
                            <div class="form-bottom">
                                ...
                                @endif
                                <form role="form" action="{{ url('admin/login') }}" method='POST' id="login-form" class="registration-form form-validate">
                                    {{ csrf_field() }}
