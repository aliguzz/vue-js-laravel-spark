                  ...
                  <div class="main-wrap">
                    <div class="container">
                         @foreach(@$id_project as $idproj)
                                    ...
                                    <img src="{{asset('assets/images/email-icon-large.png')}}">
                                    </div>
                                    </div>
                                                      ...
                                                      <div class="modal-header">
                                                        ...
                                                        <div class="table-box">
                                                            ...
                                                            <div class="row" id="myaallwebsitetemplates">
                                                                ...
                                                                <div class="col-lg-3 col-md-6 col-sm-12"><a href="{{url('admin/contacts/emails/' . $proj->id . '/lists') }}"><div class="home-img-as"><img src="{{ asset('storage/projects/'.Auth::user()->id.'/'.$proj->uuid.'/thumbnail.png') }}" alt="img-01" class="img-fluid"><div class="footer-img-home"><div class="img-mane">{{$proj->template}}</div></div></div></a></div>
                                                                @endforeach
                  ...
                  <div class="selectors-bar">       
                    <div class="scrollmenu selectors-container">          
                     <ul class="selectors nav nav-tabs">
                      ...
                      <li class="slide"><a class="active" data-toggle="tab" href="#home"><div class="curve"><div class="icon"><img src="{{asset('assets/images/response.svg')}}" /> </div></div> <span>Response</span></a></li>
                         @endif
                      
                        @if(have_premission(array(21,24)))
                      <li class="slide"><a data-toggle="tab" href="#menu1"><div class="curve"><div class="icon"><img src="{{asset('assets/images/settings-web.svg')}}" /></div></div> <span>Settings</span></a></li>
                        ...
                        @if(have_premission(array(18,19,20)))
                      <li class="slide"><a data-toggle="tab" href="#menu2"><div class="curve"><div class="icon"><img src="{{asset('assets/images/user.svg')}}" /></div></div> <span>Users</span></a></li>
                        @endif
                      
                        @if(have_premission(array(26)))
                      <li class="slide"><a data-toggle="tab" href="#menu3"><div class="curve"><div class="icon"><img src="{{asset('assets/images/icon1.svg')}}" /></div></div> <span>Support</span></a></li>
                        ...
                        @if(have_premission(array(16,17)))
                        ...
                        <div id="home" class="tab-pane active in">
                          ...
                          <div class="col-sm-12">
                           <div class="right-content right-content-space fix-width">
                            <h4 class="warning">This is your email auto response. If you wish to change it press the edit button below.</h4>
                            ...
                            <div class="editor-footer w-100">      
                                @foreach(@$email_templates as $et)
                             <a href="{{url('/admin/email-templates/'.$et->id.'/advance-builder?ref='.url()->current())}}" class="fancy-btn-reverse float-right" title="">
...
<!--                                        <span class="hidden-md-down"> See Video Tutorials 
                                        ...
                                        <div class="editor-container">
                                            ...
                                            @if($project_webiste_response_status == 0)
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            @endforeach
                                            ...
                                            @if(have_premission(array(24)))
                                        <div class="editor-footer w-100"> 
                                            <button type="button" id="editbtnsection"  class="overbtnnone">
                        ...
                        <div class="editor-container">
                            <div class="objective-wrap">
                              <div class="top-box">
                                  ...
                                  @if($project_email_response_status == 0)
                                    <li>Email Responses: <button type="button" class="btn btn-info switchemail" data-btntype="emailbtn">Not set</button></li>
                                  @else
                                    <li>Email Responses: <button type="button" class="btn btn-primary switchemail" data-btntype="emailbtn">Set</button></li>
                                  @endif
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table min-width1">
                                                            <tbody class="addnewusertr">
                                                                @if(@$emailsdata->emails && $emailsdata->emails!= '')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><span class="flex"><img class="img-fluid" src="{{asset('assets/images/icon-4.jpg')}}">{{@$nameemail[1]}}</span></td>
                                                                    
                                                                    <td class="text-center text-primary">
                                                                        @if(have_premission(array(25)))
                                                                        <a href="javascript:void(0)" data-useremail="{{@$nameemail[1]}}" data-username="{{$nameemail[0]}}" data-project_id="{{$ProjectData->id}}" class="sendtestemailuser"> Send Test Email > 
                                                                        </a>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="mr-auto col-md-8 ml-auto">
                                                                                        <form action="" method="post" id="addnewuserform">
                                                                                            ...
                                                                                            <div class=""><label for="text" class="col-form-label">Full Name</label></div>
                                                                                            <div class=""><input type="text" name="owner_name" maxlength="50" class="form-control" placeholder="Name"></div>
                                                                                            <div class=""><label for="email" class="col-form-label">Email Address</label></div>
                                                                                            <div class=""><input type="text" name="emails" class="form-control form" id="emailid" placeholder="Email"></div>
                                                                                            
                                                                                            <button type="button" id="submitadduser" class="btn-preview float-right overbtnnone">Add</button>
                                                                                        </form>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                               ...
                               <div class="right-content right-content-space fix-width">
                                <div class="header-title">
                                  ...
                                  <div class="right-part">
                                   ...
                                   <a class="icon-green" id="export_leads" style="cursor:pointer;" title="">
...
$(document).on('click',"#submitadduser",function () {
    ...
    var _token = $('meta[name="csrf-token"]').attr('content');
        ...
        $.ajax({
            ...
            url: site_url + "/admin/addnewowneruser",
            type: 'post',
...
//    throw new Error();
    element = $(this);
         $.ajax({
        url: site_url + "/admin/send_test_email_user_pm",
        type: 'post',
        data: {'username': username, 'useremail': useremail, 'project_id': project_id, '_token': CSRF_TOKEN},
...
//        data: {'id': id, 'is_active': is_active, 'project_id': project_id, '_token': CSRF_TOKEN},
    ...
    $(document).on('click', '.switchstatus, .switchemail, .switchwebsite', function () {
    var data_btntype = $($(this)).attr('data-btntype');
    $("#loading").show();
    dontknow = $(this);
         $.ajax({
        url: site_url + "/admin/chpastatus",
        type: 'post',
        ...
        success: function (data) {
            ...
            if(data_btntype == 'emailbtn' && data === '1'){
                $(dontknow).removeClass('btn btn-info');
                $(dontknow).addClass('btn btn-primary');
                $(dontknow).html('Set');
            ...
            }else if(data_btntype == 'emailbtn' && data === '0'){
                $(dontknow).removeClass('btn btn-primary');
                $(dontknow).addClass('btn btn-info');
