                        ...
                        <div class="col-md-3">
                            <a class="integ_bx" href="#">
                                <div class="cf-flex-image">
                                    <img src="{{asset('frontend/images/intergration/01.png')}}" alt="">
                                </div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            <div class="zap-service" style="background-image: url('{!!asset('frontend/images/favicon.ico')!!}')"></div>
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/01.png')}}')">
                                            </div>
                                        </div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/02.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/03.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/04.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/05.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/06.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/07.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/08.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/09.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
                                ...
                                <div class="zap-row">
                                    <div class="zap-inner-container">
                                        <div class="zap-services">
                                            ...
                                            <div class="zap-arrow" style="background-image: url('{{asset('frontend/images/arrow_icon.svg')}}')"
                                            ></div>
                                            <div class="zap-service" style="background-image: url('{{asset('frontend/images/ico/10.png')}}')">
                                            </div>
                                        </div>
                                        <div class="zap-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut </div>
                                        <div class="zap-cta"><a class="zap-button" href="">Use this Zap</a></div>
