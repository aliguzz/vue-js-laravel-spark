            ...
            <div id="menu1" class="right-content-space fix-width">
                ...
                <div class="editor-domain-container-heading">
                    <div class="page-header">
                        ...
                        <h1>Images 
                            @if(have_premission(array(124)))
                            <a href="{{url('/admin/images/create')}}" class="btn btn-info pull-right">Add New Images</a>
                            @endif
                        </h1>
                    ...
                    <table class="table table-hover table-nomargin no-margin table-bordered table-striped" id="table_st">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!!$bg['name']!!}</td>
                                <td>
                                    @if(have_premission(array(125)))
                                    <a class="edite-btn" href="{{ url('/admin/images/'.$bg['id'].'/edit')}}"><i class="fa fa-edit fa-fw"></i></a>
                                    @endif
                                    
                                    @if(have_premission(array(126)))
                                        {!! Form::open([
                                        'method'=>'DELETE',
                                        'url' => ['admin/images', $bg['id']],
