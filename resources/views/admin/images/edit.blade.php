        ...
        <div class="tab-content">
            <div id="menu1" class="right-content-space fix-width">
                ...
                <div class="editor-domain-container-heading">
                    <div class="page-header"><h3>{!!$action!!} Images</h3></div>
                </div>

                 <div class="box-content">
                <?php //echo '<pre>'; print_r($ImagesCategories); exit;?>
                <form id="lg-form" class="form-horizontal form-validate" action="{{url('/admin/images')}}" method="POST" enctype="multipart/form-data" novalidate>
                    <div class="form_wrap border">
                        

                        <div class="form-group">
                            <label class="col-sm-12 padding0 control-label" for="name">Select Images Category</label>
                            <div class="col-sm-12 padding0">
                                <select  class="form-control" name="cat_id" id="cat_id" row="15" required aria-required="true" data-rule-required="true" >

                                    @if($ImagesCategories)
                                    @foreach($ImagesCategories as $cat)								
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 padding0">
                                <input type="text" class="form-control" name="display_name" id="display_name" placeholder="Enter Image Name" data-rule-required="true" aria-required="true" value="{!!@$image->display_name!!}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 padding0 control-label" for="type">Image</label>
                            <div class="fileupload fileupload-new col-md-8 padding0" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="max-width: 200px; max-height: 150px;">
                                    ...
                                    <img class="image-display" id="image_upload_preview" src="{{asset('uploads/images/'.$image->file_name)}}" />
                                    @else 
                        ...
                        <div class="row">
                            <div class="col-sm-offset-2 col-sm-12 text-right">
                                <a href="{{url('/admin/images')}}" class="btn btn-default">Cancel</a>
