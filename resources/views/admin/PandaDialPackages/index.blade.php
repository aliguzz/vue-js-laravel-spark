...
<div class="main_panel contentarea clearfix">
    <div class="white_box container-fluid clearfix">
        <div class="page-header"><h1>PandaDial Packages 
                @if(have_premission(array(116)))
                <a href="{{url('/admin/dial-packages/create')}}" class="btn btn-info pull-right">Add New PandaDial Package</a>
                @endif
            </h1></div>
        <div class="row" >
            <div class="col-md-12">
                <div class="box">
                    <div class="box-content">
                        <table class="table table-hover table-nomargin no-margin table-bordered table-striped">
                            <thead>
                                <tr>
                                  ...
                                  <th>Auto Attend</th>
                                    ...
                                    <th>Fully Integrated with Control Panda</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(have_premission(array(117)))
                                        <a href="{{ url('/admin/dial-packages/'.$package->id.'/edit')}}"><i class="fa fa-edit fa-fw"></i></a>
                                        @endif
                                        @if(have_premission(array(118)))
                                        {!! Form::open([
                                        'method'=>'DELETE',
                                        'url' => ['admin/dial-packages', $package->id],
                        ...
                        <nav class="pull-right">{!! $DialPackages->render() !!}</nav>
                    </div>
                </div>
            </div>
        </div>
