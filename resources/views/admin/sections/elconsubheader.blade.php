                        ...
                        <div class="selectors-bar">							
                            <div class="scrollmenu selectors-container">										
                                <ul class="selectors nav nav-tabs">
                                    @if(have_premission(array(149,150,151)))
                                    <li class="slide"><a data-toggle="tab" @if($segment2 == 'contacts' && isset($_GET['el'])) class="active" @endif href="#menu2"><div class="curve"><div class="icon"><i class="fa fa-envelope"></i></div></div> <span>Email List</span></a></li>
                                    @endif

                                    @if(have_premission(array(89,90,148)))
                                    <li class="slide"><a data-toggle="tab" @if($segment2 == 'contacts' && !isset($_GET['el'])) class="active" @endif href="#menu9"><div class="curve"><div class="icon"><img src="{{asset('frontend/images/contacts.svg')}}" /></div></div> <span>Contacts</span></a></li>	
                                    @endif
