        ...
        <div class="tab-content">
            <div id="menu1" class="right-content right-content-space fixed-width">
                ...
                <div class="editor-domain-container-heading">
                    ...
                    <h1>Help Articles <span class="badge txt-radius2">{{count($cats)}}</span>
                            @if(have_premission(array(99)))
                            <a href="{{url('/admin/help-articles/create')}}" class="btn btn-info pull-right">Add New Help Article</a>
                            @endif
                        </h1>
                        </div>
                            ...
                            <table class="table table-hover table-nomargin no-margin table-bordered table-striped" id="table_st">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(have_premission(array(100)))
                                            <a class="edite-btn" href="{{ url('/admin/help-articles/'.$bg->id.'/edit')}}"><i class="fa fa-edit fa-fw"></i></a>
                                            @endif
                                            @if(have_premission(array(101)))
                                            {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['admin/help-articles', $bg->id],
                                    ...
                                    @endforeach
                                    @if (count($cats) == 0)
                                    <tr><td colspan="7"><div class="no-record-found alert alert-warning">No Help article found!</div></td></tr>
                                    @endif
                                </tbody>
                            </table>
                        </div>
