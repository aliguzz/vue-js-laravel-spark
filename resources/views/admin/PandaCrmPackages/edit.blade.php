...
<div class="breadcrumbs contentarea">
    <div class="container-fluid">
        <ul>
            ...
            <li>
                <a href="{{url('/admin/crm-packages')}}">PandaCRM Packages</a>
                <i class="icon-angle-right"></i>
            </li>
            <li>
                <a>{!!$action!!} PandaCRM Package</a>
            </li>
        </ul>
    </div>    
...
<div class="main_panel contentarea clearfix">
    <div class="white_box container-fluid clearfix">
        <div class="page-header"><h1>{!!$action!!} PandaCRM Package</h1></div>
        <div class="box">
            <div class="box-content">
                <form id="Crmpackages-form" class="form-horizontal form-validate" action="{{url('/admin/crm-packages')}}" method="POST" novalidate="novalidate">
                    <div class="form_wrap">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-sm-offset-4 col-sm-8 text-right">
                                    <a href="{{url('/admin/crm-packages')}}" class="btn btn-default">Cancel</a>
