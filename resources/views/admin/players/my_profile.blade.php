                            ...
                            <div class="offset-sm-4 col-sm-4">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail">
                                            ...
                                            <img style="width:  200px !important;max-width:  200px !important;" class="image-display" src="{{asset('frontend/images/avt.png')}}" />
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="first_name" name="name" class='form-control' placeholder="Enter First Name" data-rule-required="true" aria-required="true" value="{!!@$user['name']!!}"/>
                                            </div>
                                        </div>    
                                    </div>
