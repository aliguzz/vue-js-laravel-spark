            ...
            <div id="menu1" class="right-content-space fix-width">
                ...
                <div class="editor-domain-container-heading">
                    <div class="page-header">
                        ...
                        <h1>Vector Images 
                            @if(have_premission(array(128)))
                            <a href="{{url('/admin/vector/create')}}" class="btn btn-info pull-right">Add Vector Image</a>
                            @endif
                        </h1>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-nomargin no-margin table-bordered table-striped" id="table_st">
                        ...
                        <tbody>
                            ...
                            <tr>
<!--                                <td><img style="width: 100px;" src="{!! asset($destinationPath_thumb.'/'.$bg['file_name'])!!}"></td>-->
                                <td>{!!$bg['display_name']!!}</td>

                                <td>{!!$bg['name']!!}</td>
                                <td>
                                    @if(have_premission(array(129)))
                                    <a class="edite-btn" href="{{ url('/admin/vector/'.$bg['id'].'/edit')}}"><i class="fa fa-edit fa-fw"></i></a>
                                    @endif
                                    
                                    @if(have_premission(array(130)))
                                        {!! Form::open([
                                        'method'=>'DELETE',
                                        'url' => ['admin/vector', $bg['id']],
                                        'style' => 'display:inline'
                                        ]) !!}
                                        {!! Form::button('<i class="fa fa-trash fa-fw" title="Delete vector image"></i>', ['class' => 'delete-form-btn delete-style']) !!}
